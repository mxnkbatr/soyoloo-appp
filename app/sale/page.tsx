                    ...
                    <div className="space-y-4">
                      <div className="grid grid-cols-2 gap-3">
                        <input
                          ...
                          placeholder="Min"
                          className="w-full px-3 py-2 text-sm border border-gray-200 rounded-lg outline-none focus:border-red-500"
                        />
                        <input
                          type="number"
                          value={maxPrice}
                      ...
                      <div className="flex gap-2 pt-2 border-t border-gray-100">
                        <button
                          ...
                          className="flex-1 px-4 py-2 text-sm font-medium text-gray-600 bg-gray-100 rounded-lg"
                        >
                          {t("filters", "clear")}
                        </button>
                        <button
                          onClick={() => setShowPriceFilter(false)}
                          className="flex-1 px-4 py-2 text-sm font-bold text-white bg-red-600 hover:bg-red-700 rounded-lg"
                        >
                          {t("filters", "apply")}
                        </button>
                      </div>
